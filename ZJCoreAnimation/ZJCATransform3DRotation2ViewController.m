...
- (IBAction)sliderValueChange:(UISlider *)sender {
    ...
    if (sender.tag == 0) {
        self.frontView.layer.transform = CATransform3DRotate(self.frontView.layer.transform, sender.value, 1, 1, 0);
    }else if (sender.tag == 1) {
        self.frontView.layer.transform = CATransform3DRotate(self.frontView.layer.transform, sender.value, 1, 0, 1);
    }else if (sender.tag == 2) {
        self.frontView.layer.transform = CATransform3DRotate(self.frontView.layer.transform, sender.value, 0, 1, 1);
    }else if (sender.tag == 3) {
        self.frontView.layer.transform = CATransform3DRotate(self.frontView.layer.transform, sender.value, 1, 1, 1);
    }
    _temptTransform3D = self.frontView.layer.transform;
}
